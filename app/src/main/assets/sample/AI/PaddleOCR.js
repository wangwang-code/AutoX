...
// let result = paddle.ocr(img, cpuThreadNum, useSlim)
let result = paddle.ocr(img, cpuThreadNum, useSlim, useOpencl)
...
const stringList = paddle.ocrText(img, cpuThreadNum, useSlim, useOpencl)
