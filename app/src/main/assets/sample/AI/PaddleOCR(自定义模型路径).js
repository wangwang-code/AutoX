...
let cpuThreadNum = 4
// 新增：自定义模型路径(必须是完整路径)
// 使用时请将自定义路径 myModelPath 改为拥有读写权限的目录，否则可能引起程序崩溃
// 目录中必须包含三个模型文件： ch_ppocr_mobile_v2.0_cls_opt.nb ch_ppocr_mobile_v2.0_det_opt.nb ch_ppocr_mobile_v2.0_rec_opt.nb，否则将改用内置的模型。
let myModelPath = "/sdcard/Android/data/org.autojs.autojs.dev/models/ocr_v2_for_cpu";
